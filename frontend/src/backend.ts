...
import type { ApkMetadata as _ApkMetadata, Category as _Category, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addListing(arg0: ApkMetadata): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addListing(to_candid_ApkMetadata_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllListings(): Promise<Array<[string, ApkMetadata]>> {
        if (this.processError) {
            try {
    ...
    async getListing(arg0: string): Promise<ApkMetadata | null> {
        if (this.processError) {
            try {
    ...
    async getListingsByCategory(arg0: Category): Promise<Array<[string, ApkMetadata]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListingsByCategory(to_candid_Category_n3(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListingsByCategoryText(arg0: string): Promise<Array<[string, ApkMetadata]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListingsByCategoryText(arg0);
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchListings(arg0: string): Promise<Array<[string, ApkMetadata]>> {
        if (this.processError) {
            try {
    ...
    async updateListing(arg0: string, arg1: ApkMetadata): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateListing(arg0, to_candid_ApkMetadata_n1(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ApkMetadata_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ApkMetadata): ApkMetadata {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ApkMetadata]): ApkMetadata | null {
    return value.length === 0 ? null : from_candid_ApkMetadata_n9(_uploadFile, _downloadFile, value[0]);
}
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        modFeatures: value.modFeatures,
        category: from_candid_Category_n11(_uploadFile, _downloadFile, value.category),
        iconUrl: value.iconUrl
    };
}
function from_candid_tuple_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _ApkMetadata]): [string, ApkMetadata] {
    return [
        value[0],
        from_candid_ApkMetadata_n9(_uploadFile, _downloadFile, value[1])
    ];
}
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "app" in value ? Category.app : "game" in value ? Category.game : value;
}
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[string, _ApkMetadata]>): Array<[string, ApkMetadata]> {
    return value.map((x)=>from_candid_tuple_n8(_uploadFile, _downloadFile, x));
}
function to_candid_ApkMetadata_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ApkMetadata): _ApkMetadata {
